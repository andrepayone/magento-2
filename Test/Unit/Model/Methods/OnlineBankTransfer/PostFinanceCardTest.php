...
use Payone\Core\Model\Methods\OnlineBankTransfer\PostFinanceCard as ClassToTest;
...
class PostFinanceCardTest extends BaseTestCase
{
    ...
    public function testGetPaymentSpecificParameters()
    {
        ...
        $expected = ['onlinebanktransfertype' => ClassToTest::METHOD_OBT_SUBTYPE_POSTFINANCE_CARD, 'bankcountry' => 'CH'];
        $this->assertEquals($expected, $result);
    }
}
