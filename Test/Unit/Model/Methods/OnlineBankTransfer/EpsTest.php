...
use Payone\Core\Model\Methods\OnlineBankTransfer\Eps as ClassToTest;
...
class EpsTest extends BaseTestCase
{
    /**
     * @var ClassToTest
     */
    ...
    public function testGetSubTypeSpecificParameters()
    {
        ...
        $expected = ['bankcountry' => 'AT', 'bankgrouptype' => 'info'];
    ...
    public function testGetBankGroups()
    {
        $result = ClassToTest::getBankGroups();
